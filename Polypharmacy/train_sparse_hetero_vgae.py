...
from models import SparseHeteroVGAE
from metrics import *
from data import *
import time
import numpy as np
...
model = SparseHeteroVGAE(in_dims, hidden_dims, out_dim, num_layer, train_data.node_types, train_data.edge_types,
                        decoder_map, relation_2_decoder, latent_encoder_type = "linear", dropout = 0.5, device =device).to(device)
